...
![Game Vibe Coders — AI와 함께 만드는 우리만의 바이브]({{ site.baseurl }}/images/logo-light.png){: .hero-image .hero-image--wide }
...
발표자가 강의하는 자리가 아니라, 각자 실무에서 겪은 시행착오와 적용 사례를 들고 와서 나누는 자리입니다.
